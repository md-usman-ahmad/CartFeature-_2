...
export function Navbar({ currentDisplay }) {
  const [activeLink, setActiveLink] = useState("Home");
  return (
    <>
      {/* <nav class="bg-white border-gray-200 dark:bg-gray-900 bg-blue-900">
          ...
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
              <div class="flex items-center">
                <h1 class="text-2xl font-bold text-gray-900">🛍️ ShopEase</h1>
              </div>
              <nav class="hidden md:flex space-x-8">
                <a
                  ...
                  class={`cursor-pointer font-medium ${
                    activeLink === "Home" ? "text-blue-600" : "text-gray-700 hover:text-blue-600"
                  }`}
                >
                  Home
                </a>
                <a class="text-gray-700 hover:text-blue-600 font-medium pointer-events-none">Men</a>
                <a class="text-gray-700 hover:text-blue-600 font-medium pointer-events-none">
                  Women
                </a>
                <a
                  onClick={() => {
                  ...
                  class={`cursor-pointer font-medium ${activeLink === "Electronics" ? "text-blue-600" : "text-gray-700 hover:text-blue-600" }`}
                >
                  Electronics
                </a>
              </nav>
              <div class="flex items-center space-x-4">
                <button class="text-gray-700 hover:text-blue-600 relative" onClick={() => {
